<script context='module'>
	...
	export async function load() {
		...
		const total_journal_entries = entries.results.length;
...
<main>
	...
	<p>
	This is where I put the things I’m interested in. You should check out <a class='highlighted' href='/journal'>my journal</a>, where I have rambled exactly { total_journal_entries } time{ total_journal_entries !== 1 ? 's' : '' } —with varying degrees of eloquence— about something or other.
	</p>
	<p>
